...
{{--                <i class="ri-record-circle-fill font-size-10  me-1 ms-0 d-inline-block {{ (auth()->user()->is_active == 1) ? "text-success" : "text-danger" }}"></i>--}}
{{--                {{ errorCheck((auth()->user()->is_active == 1) ? "Active" : "Deactivate" ) }}</p>--}}
        </div>
        <!-- End profile user -->
        ...
        <div class="p-4 user-profile-desc" data-simplebar>
            <div class="text-muted text-center">
                <p class="mb-4" style="word-break: break-all"> {{ errorCheck(auth()->user()->about)  }}.</p>
            </div>
